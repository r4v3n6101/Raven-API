...
public class RotatedAxes {
    ...
    //Find a global raven.api.utils.math.vector in terms of this basis.
    public Vector3f findGlobalVectorLocally(Vector3f in) {
        //Create a new matrix and use the first column to store the raven.api.utils.math.vector we are rotating
    ...
    //Find a local raven.api.utils.math.vector in terms of the global axes.
